# Master PowerShell script to run both projects and generate comparison report

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "REGRESSION TESTING - MASTER EXECUTION" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""

# Project A - Stable Version
Write-Host "Step 1/3: Running Project A - Stable Implementation" -ForegroundColor Yellow
Write-Host "----------------------------------------------------" -ForegroundColor Yellow
Set-Location Project_A_Stable
python test_original.py 2>&1 | Tee-Object -FilePath log_original.txt
"" | Out-File -FilePath time_original.txt -Append
"Test execution completed at: $(Get-Date)" | Out-File -FilePath time_original.txt -Append
Set-Location ..
Write-Host ""

# Project B - Buggy Version
Write-Host "Step 2/3: Running Project B - Buggy Implementation" -ForegroundColor Yellow
Write-Host "---------------------------------------------------" -ForegroundColor Yellow
Set-Location Project_B_Buggy
python test_buggy.py 2>&1 | Tee-Object -FilePath log_buggy.txt
"" | Out-File -FilePath time_buggy.txt -Append
"Test execution completed at: $(Get-Date)" | Out-File -FilePath time_buggy.txt -Append
Set-Location ..
Write-Host ""
...
Write-Host "  - Project A logs: Project_A_Stable\log_original.txt"
Write-Host "  - Project B logs: Project_B_Buggy\log_buggy.txt"
Write-Host "  - Comparison: compare_report.md"
Write-Host ""
